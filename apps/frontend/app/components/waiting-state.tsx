...
export function WaitingState({ answeredCount, totalCount }: WaitingStateProps) {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto p-8 md:p-12 bg-card">
      <div className="flex flex-col items-center justify-center space-y-6">
        <Loader2 className="h-12 w-12 md:h-16 md:w-16 animate-spin text-primary" />

        <div className="text-center space-y-2">
          <h2 className="text-xl md:text-2xl font-bold text-card-foreground">Waiting for others...</h2>
        ...
        <div className="w-full space-y-2">
          <div className="w-full bg-muted/30 rounded-full h-2 md:h-3 overflow-hidden">
            <div
